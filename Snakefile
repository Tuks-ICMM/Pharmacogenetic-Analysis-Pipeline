...
rule ALL_COLLATE:
    ...
    run:
        ...
        shell("module load plink-2; plink2 --vcf .intermediates/COLLATE/ALL_PRE.vcf.gz --fa {wildcards.ref} --ref-from-fa force --allow-extra-chr --export vcf bgz --out .intermediates/COLLATE/ALL_REF.vcf.gz"),
